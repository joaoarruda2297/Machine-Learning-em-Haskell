...
/* package projeto-ml-0.1.0.0 */
#ifndef VERSION_projeto_ml
#define VERSION_projeto_ml "0.1.0.0"
#endif /* VERSION_projeto_ml */
#ifndef MIN_VERSION_projeto_ml
#define MIN_VERSION_projeto_ml(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projeto_ml */
...
#define CURRENT_COMPONENT_ID "projeto-ml-0.1.0.0-EWG96fUxy4f6vBYU4QsaKw-projeto-ml"
