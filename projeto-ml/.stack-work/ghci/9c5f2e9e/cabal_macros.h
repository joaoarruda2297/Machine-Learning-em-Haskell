...
/* package leitura-csv-0.1.0.0 */
#ifndef VERSION_leitura_csv
#define VERSION_leitura_csv "0.1.0.0"
#endif /* VERSION_leitura_csv */
#ifndef MIN_VERSION_leitura_csv
#define MIN_VERSION_leitura_csv(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_leitura_csv */
...
#define CURRENT_COMPONENT_ID "leitura-csv-0.1.0.0-6RkEtFN3Q7vFJEE3ivurWL-leitura-csv"
